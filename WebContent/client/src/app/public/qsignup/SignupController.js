define(['src/app/res/AppConstants'], function(appConsts) {
	return ['$window', '$state', 'spinnerService', 'SignupModel', 'AuthHttpService', 'appUrisService', ctrlr];
	
	function ctrlr($window, $state, spinnerService, SignupModel, AuthHttpService, appUrisService) {
		var vm = this;
